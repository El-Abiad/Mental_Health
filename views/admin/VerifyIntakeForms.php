...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'Verify') {
    ...
    header('Location: /Mental_Health/controllers/admin_run.php?action=verifyIntakeForms&msg=success');
    exit;
}
                ...
                <tr>
                    ...
                    <td>
                        <?php if (!$form['isVerified']): ?>
                            <form action="/Mental_Health/controllers/admin_run.php?action=verifyIntakeForms" method="POST" style="display:inline;" onsubmit="return confirm('Verify this form?')">
