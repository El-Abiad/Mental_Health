...
<div class="container-fluid px-4">
  ...
  <div class="row g-3 mb-4">
    <div class="col-md-4">
      <a href="/Mental_Health/controllers/manager_run.php?action=assignTherapist"
    ...
    <div class="col-md-4">
      <a href="/Mental_Health/controllers/manager_run.php?action=verifyTherapists"
        class="card border-0 shadow-sm text-decoration-none h-100 card-hover">
        <div class="card-body d-flex align-items-center gap-3 p-3">
    ...
    <div class="col-md-4">
      <a href="/Mental_Health/controllers/schedule_run.php?action=viewSchedule"
        class="card border-0 shadow-sm text-decoration-none h-100 card-hover">
        <div class="card-body d-flex align-items-center gap-3 p-3">
  ...
  <div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center pt-3">
      ...
      <a href="/Mental_Health/controllers/schedule_run.php?action=viewSchedule" class="btn btn-sm btn-outline-primary">View All</a>
    </div>
  ...
  <?php if (!empty($cancelled)): ?>
    <div class="card border-0 shadow-sm border-start border-danger border-3">
      <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center pt-3">
        ...
        <a href="/Mental_Health/controllers/session_run.php?action=cancelledSessions" class="btn btn-sm btn-outline-danger">View All</a>
      </div>
      <div class="card-body p-0">
        <div class="table-responsive">
          <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
              <?php foreach (array_slice($cancelled, 0, 5) as $c): ?>
                <tr>
                  ...
                  <td>
                    <a href="/Mental_Health/controllers/session_run.php?action=cancelledSessions"
