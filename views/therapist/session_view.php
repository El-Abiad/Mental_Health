...
<div class="container my-4">
    ...
    <div class="mb-3">
        <a class="btn btn-success" href="/Mental_Health/controllers/therapist_run.php?action=startSession&id=<?= (int)$session['id'] ?>">Start</a>
        <a class="btn btn-secondary" href="/Mental_Health/controllers/therapist_run.php?action=endSession&id=<?= (int)$session['id'] ?>">End</a>
    </div>
    <form method="post" action="/Mental_Health/controllers/therapist_run.php?action=saveNote&id=<?= (int)$session['id'] ?>" class="mb-4">
