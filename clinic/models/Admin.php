...
class Admin extends User
{
    ...
    public static function UpdateViolationReport(int $reportid, int $resolvedid, string $status): bool
    {

        $db = Database::getConnection();

        $sql = "UPDATE violationreport SET ResolvedBy=$resolvedid, Status='$status' WHERE ReportId=$reportid";
